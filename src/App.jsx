...
// serverless function (api/generate.js, deployed alongside the app on Vercel).
// Set VITE_API_URL at build time to override (see vite.config.js).
const API_URL =
  (typeof __API_URL__ !== "undefined" && __API_URL__) || "/api/generate";
